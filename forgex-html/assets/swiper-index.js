...
import {c as s, G as r, T as a, R as l, C as c, a as m, P as h, V as p, M as g, b as x, S as d, N as u} from "./vendor.3.js";
!function() {
...
class K {
    ...
    loadTextures() {
        ...
        this.images = [],
        this.textures = [];
        return (this.swiper && this.swiper.isElement ? this.swiper.hostEl : this.container).querySelectorAll(".swiper-gl-image").forEach((e=>{
    ...
    createMaterial() {
        return new h(this.gl,((e,s)=>{
            for (var r in s || (s = {}))
                n.call(s, r) && i(e, r, s[r]);
            if (t)
                for (var r of t(s))
                    o.call(s, r) && i(e, r, s[r]);
            return e
        }
        )({
            extensions: {
            ...
            const e = function(e, t, n) {
                ...
                for (let r = 0; r < a; r += 1) {
                    ...
                    for (let e = 0; e <= o; e += 1) {
                        ...
                        c.push(e * i - i / 2 + d - 1, s + v - 1, 0),
                        x.push((e * i - i / 2 + d) / 2, (s + v) / 2);
                        let y = w(e / a, r / a) + Math.random();
                        const U = f(v / 2 + 2 * y / t);
                        let E = Math.random();
                        l.push(U, f(U + .1 * n), f(U + .1 * n)),
                        g.push(E, E, E);
    ...
    setProgress(e, t, n, o, i) {
        ...
        const s = this.textures[t]
          , r = this.textures[e];
        if (this.material.uniforms.texture1.value = r,
        this.shader.vertex ? this.vertexMaterial.uniforms.texture1.value = s : this.material.uniforms.texture2.value = s,
        i) {
            ...
            this.animateUniform(this.material.uniforms.progress, n, (()=>{
                ...
                1 === n && (this.material.uniforms.texture1.value = s),
...
const I = new d(".fx-hero-1-active",{
    modules: [u, function({swiper: e, on: t, extendParams: n}) {
        ...
        t("setTranslate", (()=>{
            ...
            if (e.slides.forEach(((o,i)=>{
                const s = o.progress;
                e.params.cssMode && 0 === Math.round(100 * s) && (c = !0),
                (s > 0 && s < 1 || 0 === s && e.progress < r) && (t = i,
                n = i + 1,
                a = s,
                l = t),
                (s < 0 && s > -1 || 0 === s && e.progress > r) && (t = i - 1,
                n = i,
                a = 1 + s,
                l = n)
            }
            ...
            e.params.loop || h === m || (t = m,
            n = h),
            e.gl.setProgress(t, n, a, s, c)
        }
        )),
        t("setTransition", ((t,n)=>{
